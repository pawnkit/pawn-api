...
- Use pawn-parser v1.5.11 for include declaration parsing.

## 0.19.6 - 2026-08-03

### Changed

- Use pawn-parser v1.5.10 for include declaration parsing.
...
- Use pawn-parser 1.5.8 for include declaration parsing.
